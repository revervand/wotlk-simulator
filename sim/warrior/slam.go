...
func (warrior *Warrior) registerSlamSpell() {
	warrior.Slam = warrior.RegisterSpell(core.SpellConfig{
		...
		DamageMultiplier: 1 + 0.02*float64(warrior.Talents.UnendingFury) + core.TernaryFloat64(warrior.HasSetBonus(ItemSetWarriorDPST4, 4), 0.45, 0) + core.TernaryFloat64(warrior.HasSetBonus(ItemSetDreadnaughtBattlegear, 2), 0.1, 0),
